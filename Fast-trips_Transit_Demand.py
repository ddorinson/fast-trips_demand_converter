...
def trip_list(transit_mode_id, eligible_zones_list, min_depart_time, max_depart_time, time_period):
    ...
    transit_table['mode_id'] = transit_table['mode_Orig'] + transit_table['mode_Dest']
...
transit_trips.to_csv(r'H:\fast trip\Soundcast_fastttrips_demand_v0.1\trip_list.txt', columns = ['person_id', 'o_taz', 'd_taz', 'mode', 'purpose', 'departure_time', 'arrival_time', 'timePeriod', 'time_target', 'vot'], index = False, sep=',') 
